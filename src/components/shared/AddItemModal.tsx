      ...
      <div className="flex flex-col gap-5 p-[18px]">
        ...
        <div className="flex w-64 flex-col gap-2">
          ...
          <div className="relative flex h-12 items-center rounded-[35.08px] bg-[#E9E9E9]">
            <button onClick={() => setSelectionType('Single')} className={cn('flex h-full flex-1 items-center justify-center rounded-3xl text-sm font-medium leading-5 transition-colors', selectionType === 'Single' ? 'bg-[#026F4F] text-white' : 'text-[#989898]')}>Single</button>
            <button onClick={() => setSelectionType('Multi')} className={cn('flex h-full flex-1 items-center justify-center rounded-3xl text-sm font-medium leading-5 transition-colors', selectionType === 'Multi' ? 'bg-[#026F4F] text-white' : 'text-[#989898]')}>Multi</button>
          </div>
        </div>
