...
export function RemoveStaffModal({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed right-0 top-0 z-50 flex h-full w-full flex-col items-center overflow-y-auto rounded-tl-3xl rounded-bl-3xl bg-[#F2F2F2] py-12 shadow-[-2px_0px_12px_rgba(0,0,0,0.10)] transition-transform duration-300 sm:w-[619px]',
